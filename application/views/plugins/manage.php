        ...
        <div class="inqbox float-e-margins">
            <div class="inqbox-title border-top-danger">
                ...
                <div class="inqbox-tools">
                    ...
                    <?= anchor("$controller_name/view/-1", "<div class='btn btn-primary btn-xs' style='float: left; margin-right:10px;'><span>" . $this->lang->line($controller_name . '_new') . "</span></div>", array('data-toggle' => 'modal', 'data-target' => '#payment_modal', 'title' => $this->lang->line($controller_name . '_new'))); ?>
